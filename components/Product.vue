<template>
    <div class="flex flex-col">
      ...
      <div class="w-full border-2 border-gray-600 rounded-sm bg-blue-gray-50 transition duration-200 hover:(bg-orange-50)">
        ...
        <nuxt-img
          class="pb-6 mx-auto hover:(animate-animated animate-infinite animate-headShake cursor-pointer) select-none"
          width="320"
          height="320"
